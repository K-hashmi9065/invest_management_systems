...
[Setup]
; Unique fixed GUID for stable upgrade detection
AppId={{8B83D432-8419-4F41-8608-FA05FBF63C2E}
AppName={#MyAppName}
...
AllowNoIcons=yes
OutputDir=Output
OutputBaseFilename=Invest-Management-Setup-{#MyAppVersion}
SetupIconFile=assets\invest-management.ico
...
[Files]
; Copy the complete Flutter Release output tree (exe, DLLs, icudtl.dat, flutter_assets)
